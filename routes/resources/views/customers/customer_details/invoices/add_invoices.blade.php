...
<div class="table-responsive">
    <table class="table invoice-detail-table">
        ...
        <tr class='item_row'>
            ...
            <td>
                <input required type='number' style='width:70px' name="item_cost[]"
                       class='form-control item_cost'  step="any" min="0" />
            ...
            <td>
                <select name="item_tax_1[]" class="form-control item_tax_1">
            ...
            <td>
                <select name="item_tax_2[]" class="form-control item_tax_2">
                    <option>Select Tax</option>
                    @foreach ($taxes as $tax)
                        <option value="{{ $tax->id }}" data-tax_rate="{{ $tax->rate }}"
                          >{{ $tax->name }}
