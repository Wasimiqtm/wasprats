...
<x-app-layout>
    <div class="pcoded-main-container">
        <div class="pcoded-content">
            <x-breadcrumb title="Invoices" :button="[]" />

            <div class="row">
                <div style="margin: 20px 0px;">

                    <input type="text" name="daterange" value="" />
                    <span data-href="/export-invoice" id="export" class="btn btn-success btn-sm" onclick ="exportTasks (event.target);">Export</span>
                </div>
    ...
    @push('scripts')
        ...
        <script>
            ...
            $("document").ready(function() {
                var datatable_url = route('invoice.details');
